...
![fish swimming GIF](/assets/research/2024-06_fish/1_fish.gif)
...
![Principal Component Analysis Pairplot](/assets/research/2024-06_fish/2_pca-pairplot.jpg)

After that, we computed persistence diagrams using [ripser](https://ripser.scikit-tda.org/) to analyze the topological features of the data. In particular, we focused on the first Betti number (β1, or H1) to identify cyclic motion in the data, which corresponded to periodic motions in the fish's swimming behavior.

![Persistence Diagram, PCA components 1 and 2, and Fish](/assets/research/2024-06_fish/3_fish-pca-persistence.gif)
...
![Water Speed vs. Cocycle Length](/assets/research/2024-06_fish/4_cocycles.png)
...
![Winona and I at JMM!](/assets/research/2024-06_fish/5_jmm.jpg)
